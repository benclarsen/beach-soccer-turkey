...
ggsave("example_results/matrix_background.png", plot = background, width = 7, height = 7, units = "in", dpi = 600, bg = "transparent")

# Read the PNG file and create a raster grob from the image
img_grob <- rasterGrob(readPNG("example_results/matrix_background.png"), width = unit(1, "npc"), height = unit(1, "npc"))
...
png("example_results/risk_matrix_beach_soccer_example.png", width=8,height=8 ,units="cm" ,res=600)
